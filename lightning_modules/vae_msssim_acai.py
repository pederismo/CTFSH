...
class VAE_MSSSIM_ACAI(VAE_MSSSIM):
    ...
    def __init__(self, latent_size, rho, lambda_fool, gamma):
        ...
        self.training_losses = {"l1": [], "kld": [], "ms_ssim": [], "fool_term": [], "discr_error": [], "discr_heurist": []}
        self.validation_losses = {"l1": [], "kld": [], "ms_ssim": [], "fool_term": [], "discr_error": [], "discr_heurist": []}
    ...
    def training_step(self, batch, batch_idx):
        ...
        image_loss = self.rho * l1 + (1 - self.rho) * ms_ssim_loss + kl_div
        ...
        reconstructions = self(originals)[0].detach()
        ...
        with torch.no_grad():
            ...
            self.training_losses["kld"].append(kl_div.detach())
